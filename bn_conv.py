...
import caffe
import numpy as np
net = caffe.Net("./TestModel.prototxt", "./TestModel.caffemodel", caffe.TEST)
...
net2 = caffe.Net("./TestModel_inference.prototxt", caffe.TEST)
...
net2.save("./TestModel_deploy.caffemodel")